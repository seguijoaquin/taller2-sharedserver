...
app.controller('myCtrl', function($scope,$http) {
  ...
  $scope.user = {name:undefined,email:undefined,alias:undefined,sex:undefined,edad:undefined,bio:undefined,interests:[],location:{latitude:undefined,longitude:undefined}}
  $scope.updated_user = {id:undefined,name:undefined,email:undefined,alias:undefined,interests:[],sex:undefined,edad:undefined,bio:undefined,location:{latitude:undefined,longitude:undefined}}
  ...
  $scope.updateUser = function () {
    $http({
      url: '/users/'+$scope.updated_user.id,
      method: "PUT",
      headers:{
        'Content-Type': 'application/json'
      },
      data: { "user" : $scope.updated_user}
    }).then(function(response) {
      console.log(response.data);
    },
    function(response) {
