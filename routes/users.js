...
router.get(Constants.DIR_LISTADO_USUARIOS, function(req, res, next) {
  ...
  query(Constants.UERY_LISTADO_USUARIOS,null,
    function(err, result) {
...
router.post(Constants.DIR_ALTA_USUARIOS,function(req, res, next) {
  ...
  query(Constants.QUERY_ALTA_USUARIO,
    [req.body.user.name,req.body.user.email,req.body.user.alias,req.body.user.location.latitude,
      req.body.user.location.longitude],
      function(err,result){
